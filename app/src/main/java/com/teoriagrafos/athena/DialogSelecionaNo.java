...
public class DialogSelecionaNo extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_dialog_seleciona_no, viewGroup, false);

        assert getArguments() != null;
        // Pega os dados que chegaram via Bundle.
        listNos = getArguments().getStringArrayList("listNos");
        algo = getArguments().getString("algo");
        ...
        builder.setView(view)
                ...
                .setPositiveButton(getString(R.string.executar),
                        (dialog, which) -> {
                            ...
                            if (listner != null) {
                                listner.applySelecionaNo(algo, origem);
                            }
                        });
    ...
    public interface HelperSelecionaNo{
        void applySelecionaNo(String algo, String noOrigem);
    }
}
