...
public class Largura extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_largura, container, false);
    }
    ...
    private void mostraExecucao(Node n){
        ...
        s.append("A Busca em largura por ").append(noOrigem).append(" Resulta em:\n\n{");
